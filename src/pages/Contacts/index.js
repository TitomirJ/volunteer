...
const Contacts = () => {
	...
	// if (lang === "uk") {
	// 	link = "https://send.monobank.ua/jar/79GfPJRKqz";
	// } else if (lang === "ru") {
	// 	link = "https://send.monobank.ua/jar/79GfPJRKqz";
	// }
			...
			<main style={{ margin: "195px 0 140px" }}>
				<div style={{ position: "relative", padding: "2px 0 0" }}>
					...
					<Container maxWidth='md'>
						<Title
							title={<FormattedMessage id='contactInfo.title' />}
						/>
						...
						<Container className={classes.requisites} maxWidth='md'>
							...
							<div>
								<p>
									...
									<br />
									<br />
									Company address: Ukraine, 69071, flat 50,
									Parhomenko 4 street, Zaporizhzhya
									<br />
									IBAN Code: UA783133990000026002030202244
									<br />
									Name of the bank:JSC CB "PRIVATBANK", 1D
									HRUSHEVSKOHO STR., KYIV, 01001, UKRAINE Bank
									SWIFT Code: PBANUA2X
									<br />
									...
									New York ,USA
									<br />
									2. Account in the correspondent
									bank:890-0085-754
									<br />
									SWIFT Code of the correspondent bank: IRVT
									US 3N
									<br />
									...
									<br />
									ETH:
									0x913f53d1216f7c6bca584a95b87f2a6d0d926bea
									<br />
									USDT (Tron):
									TD7YW1FwUf5CRrQi792ihC54hj7zhavSvg
									<br />
								</p>
							</div>
						</Container>
